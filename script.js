...
const mockDatabase = {  "rice": "Water Footprint: 2,497 liters/kg",
...
if (scanIcon) {
    scanIcon.addEventListener('click', function() {
        if (this.textContent === 'camera_alt') {
            startScanner();
        } else {
            this.textContent = 'camera_alt';
            searchBar.value = '';
        }
    });
}
...
function fetchProductDetails(barcode) {
    // This is a mock fetch. You can replace this with an actual fetch request to your backend or API.
